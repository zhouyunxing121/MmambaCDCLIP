...
dataset_path = "/home/wangshiying/gjx/rschange/data/DSIFN"  # 将此处替换为您的数据集路径
output_path = "/home/wangshiying/gjx/rschange/data/DSIFN"  # 将此处替换为您想要保存txt文件的输出路径
...
for folder_name in ["test","train","val"]:
    ...
    with open(txt_path, "w") as f:
        image_folderA = os.path.join(dataset_path, folder_name, "t1")
        image_folderB =  os.path.join(dataset_path, folder_name, "t2")
        label_folder = os.path.join(dataset_path, folder_name, "mask")
