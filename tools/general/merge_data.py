...
def process():
    ...
    print(args.p_bigimg)#test,10.1-22.59
...
if __name__ == '__main__':
    ...
    parser.add_argument('--p_bigimg', type=str, default='/home/wangshiying/gjx/rschange/data/LEVIR-CD/test/A', help='path to the big image')
    ...
    p_predbig = args.p_predslice
    if os.path.exists(os.path.join(p_predbig)) is False:
        os.mkdir(p_predbig)
    print('save to {}'.format(p_predbig))#test,10.1-22.59
    cut_size = 256
    over_lap = 64
    suffix = 'png'
