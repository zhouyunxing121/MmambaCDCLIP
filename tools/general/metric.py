...
def dir_metric(pred_path, gt_path, pred_suffix, gt_suffix, n_class):
    ...
    print(files)#test,10.1-22.58
    print(gt_path)#test,10.1-22.58
    confu_mat_total = np.zeros((n_class, n_class))
    for item in files:
        name = item.split('.')[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pppred', type=str, default='/home/dsj/0code_hub/cd_code/SegNeXt-main/work_dirs/sem_fpn_p2t_b_levir_80k_cdsa/test_result')
